...
export function ProfileEditProfile() {
    ...
    const getPreviewSrcForSize = (size: number) => previewUrl
    ...
    return (
        <div className="profile-edit-profile">
            <div className="profile-edit-profile__field">
                ...
                <small className="profile-edit-profile__description">This is your unique username that will be displayed on your profile and used in your profile URL.</small>
                <div className="profile-edit-profile__input-and-submit">
                    <input type="text" className="profile-edit-profile__input" defaultValue={user?.username} />
            ...
            <div className="profile-edit-profile__field">
                ...
                <small className="profile-edit-profile__description">Please use a picture of yourself to be displayed on your profile.</small>
                <div className="profile-edit-profile__avatar-displays">
                    <div className="profile-edit-profile__avatar-profile">
                        <img src={getPreviewSrcForSize(128)} alt="Profile preview" className="avatar__profile" />
                        <div>Profile preview</div>
                    </div>
                    <div className="profile-edit-profile__avatar-user-menu">
                        <img src={getPreviewSrcForSize(40)} alt="User menu icon preview" className="avatar__menu" />
